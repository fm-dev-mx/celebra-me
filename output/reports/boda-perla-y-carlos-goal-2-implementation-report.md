---
title: Boda Perla y Carlos — Goal 2 Implementation Report
...
- `.agent/tmp/handoffs/boda-perla-y-carlos-goal-1/implementation-audit.md`
...
| `tests/content/boda-perla-y-carlos-payload.test.ts`       | location contract assertions                                                                                                                                                                                                                                                                                                                | Verifies two distinct approved public map URLs in the Perla payload contract.                                                                                                                    |

## Render and data flow

### Invitation-wide flow preserved

`boda-perla-y-carlos` resolves through the existing dynamic route, published content resolver,
...
| F03/F15     | Opaque prep labels                     | `docs/invitations/boda-perla-y-carlos.md`                                         | None                                                                                  | Opaque source labels remain non-public                                                                 | Documentation validation                                     | Documentation                                       | Preserved                                                          | Raw paths or operational data could leak                                              | `pnpm validate:no-pii` passed                                                                                   |
...
| Perla visual profile                           | All approved visual corrections                          | Only `.event--boda-perla-y-carlos.theme-preset--jewelry-box-wedding`                          | No changes to `jewelry-box-wedding` bundle, tokens, sections, or dependencies         |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm test -- tests/unit/location-helper.test.ts tests/content/boda-perla-y-carlos-payload.test.ts tests/unit/event.adapter.test.ts tests/unit/invitation.render-plan.test.ts tests/unit/invitation.section-render-data.test.ts tests/unit/page-data.test.ts` | Passed: 6 suites, 86 tests                                                                                                                                                                                                              |
| `pnpm test -- tests/unit/location-helper.test.ts tests/content/boda-perla-y-carlos-payload.test.ts`                                                                                                                                                           | Passed: 2 suites, 12 tests after map assertions                                                                                                                                                                                         |
...
- Before baseline: `output/playwright/boda-perla-y-carlos/goal2-before-mobile-hero.png`
- After mobile hero: `output/playwright/boda-perla-y-carlos/goal2-after-mobile-hero.png`
- After sealed/opening/open: `output/playwright/boda-perla-y-carlos/goal2-after-mobile-sealed.png`,
  `goal2-after-mobile-opening.png`, `goal2-after-mobile-open.png`
- After screenshot-held letter:
  `output/playwright/boda-perla-y-carlos/goal2-after-mobile-letter-held.png`

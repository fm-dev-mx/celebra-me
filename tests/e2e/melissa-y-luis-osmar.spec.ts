...
async function expectStableInvitation(page: import('@playwright/test').Page) {
	...
	await expect(page.locator('.invitation-section-wrapper[data-section-kind]')).toHaveCount(10);

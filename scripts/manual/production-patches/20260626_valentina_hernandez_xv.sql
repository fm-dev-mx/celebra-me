...
BEGIN
  ...
  v_new_content := '{
    ...
    "sectionStyles": {
      "hero": { "variant": "editorial-magazine" },
      "quote": { "variant": "editorial-magazine" },
      "countdown": { "variant": "editorial-magazine" },
      "family": { "variant": "editorial-magazine" },
      "location": { "variant": "editorial-magazine", "showFlourishes": false },
    ...
    "envelope": {
      ...
      "stampText": "Valentina",
      "stampYear": "2026",
      "closedPalette": { "primary": "surfaceDark", "accent": "actionAccent", "background": "surfaceDark" }
    },
    "sharing": {

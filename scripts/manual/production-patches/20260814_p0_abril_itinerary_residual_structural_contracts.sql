...
-- @purpose: Historical record of the superseded Abril itinerary presentation repair; canonical publication owns itinerary.variant and omits the legacy presentation field.
-- @env: production

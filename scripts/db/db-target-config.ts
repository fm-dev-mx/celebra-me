...
export const DISPOSABLE_TEST = {
	...
	apiPort: Number(process.env.DISPOSABLE_API_PORT || 54331),
	dbPort: Number(process.env.DISPOSABLE_DB_PORT || 54332),
	studioPort: Number(process.env.DISPOSABLE_STUDIO_PORT || 54333),
	shadowPort: Number(process.env.DISPOSABLE_SHADOW_PORT || 54330),

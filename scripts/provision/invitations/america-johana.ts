...
const content: CanonicalEventContentInput = {
	...
	rsvp: {
		...
		subcopy:
			'Este pase corresponde a tu grupo. Preséntalo al ingresar al evento. Tu confirmación nos ayuda a recibirte con mucho cariño.',
		guestCap: 6,
		accessMode: 'hybrid',
	...
	family: {
		...
		labels: {
			...
			sectionMessage:
				'Con el corazón lleno de gratitud, comparto esta noche con mi familia y con quienes han acompañado mi historia.',
	...
	description:
		'XV años de América Johana, con fotografía natural, vestido rojo, marfil cálido, verde profundo y acentos champagne.',
	eventTiming: {
...
export const americaInvitation = defineCanonicalInvitation({
	...
	assetPresentation: {
		...
		gallery07: { sourcePolicy: 'preserve' },
		gallery08: { sourcePolicy: 'preserve' },
		gallery09: { sourcePolicy: 'preserve' },

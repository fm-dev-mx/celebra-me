...
import type { ActionVariants, ActionColors, BaseActionVariants, ExternalVariants } from './ActionBase';
...
const ActionExternalLink: React.FC<ActionLinkProps> = ({
  ...
  const computedVariant: ActionVariants = externalVariant ?? (`external-${variant}` as ActionVariants);

...
all schema changes must be introduced through versioned migrations in `supabase/migrations/`.
The patch entrypoint is dry-run lint only; this manifest does not authorize execution.

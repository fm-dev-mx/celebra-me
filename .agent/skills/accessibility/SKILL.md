...
standards. Every guest should be able to view and interact with invitations regardless of ability.
...
<input id="guests" type="number" aria-describedby="guests-error" aria-invalid="true" />
<span id="guests-error" role="alert"> Por favor ingrese un número entre 1 y 10 </span>
```
...
<Image src={heroImage} alt="Salón de eventos decorado para XV años" loading="eager" />
```

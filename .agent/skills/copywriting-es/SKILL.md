---
name: copywriting-es
description: Maintain consistent tone and style for Spanish-language digital invitation copy. Covers formal/warm tone, event-specific vocabulary, courtesy formulas, and common UI patterns.
---

> **Related skills**: [`accessibility`](file://.agent/skills/accessibility/SKILL.md) for accessible error messages and form labels.

...
- **Action**: Align palette with `#4B3621` (Deep Coffee) and `#D4AF37` (Aged Gold) within the
  preset.
...
- **Target**: `src/styles/invitation/_countdown.scss` &
...
- **Target**: `src/styles/invitation/_event-location.scss` &

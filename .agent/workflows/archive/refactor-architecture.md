...
This workflow ensures a safe transition from event-based logic to aesthetic presets, preserving the
landing page and existing demos.
...
- **Critical:** Remove invitation-specific imports from `src/styles/global.scss` to decouple the
  landing page.

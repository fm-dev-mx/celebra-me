...
- [ ] **Gatekeeper**: Run `[/gatekeeper-commit](.agent/workflows/gatekeeper-commit.md)`.

## 6. Cleanup

- [ ] **Archive Audit**: Move `.agent/workflows/itinerary-abstraction-audit.md` to
      `.agent/workflows/archive/`.
- [ ] **Self-Archive**: Move this workflow to `.agent/workflows/archive/` after completion.

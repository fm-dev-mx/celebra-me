...
function commit(message) {
	...
	try {
		execSync(`git commit --no-verify --author="fm-dev-mx <48076635+fm-dev-mx@users.noreply.github.com>" -m "${message}"`, { stdio: 'inherit' });
	} catch (e) {

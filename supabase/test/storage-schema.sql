...
\restrict ptJF542riLuJ2fGfBcmw7jSIX1HGI7CfsqWtQlGZSUH1gXuxBJUvRsJb64joITS
...
--
-- Name: objects public read invitation assets; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "public read invitation assets" ON storage.objects FOR SELECT USING ((bucket_id = 'invitation-assets'::text));
...
--
-- Name: objects service_role delete invitation assets; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "service_role delete invitation assets" ON storage.objects FOR DELETE TO service_role USING ((bucket_id = 'invitation-assets'::text));


--
-- Name: objects service_role write invitation assets; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "service_role write invitation assets" ON storage.objects FOR INSERT TO service_role WITH CHECK ((bucket_id = 'invitation-assets'::text));
...
\unrestrict ptJF542riLuJ2fGfBcmw7jSIX1HGI7CfsqWtQlGZSUH1gXuxBJUvRsJb64joITS

...
select hasnt_function('public', 'publish_invitation_atomic', array['uuid','uuid','timestamp with time zone','text','text','boolean','jsonb'], 'retired seven-argument publication overload is absent');

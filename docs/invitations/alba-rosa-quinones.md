...
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hero hierarchy**                    | Person → occasion → date only: `70 AÑOS` eyebrow (gold `--alba-gold`, tracking `0.24em`), `Alba Rosa Quiñónez López` display headline (Cormorant Garamond, dominant editorial gesture, line-height 1.02), `12 DE SEPTIEMBRE DE 2026` date (label font). Logistics duplicated in Hero (time/venue) hidden via profile CSS as Location owns logistics.                                                                                                                                      |
...
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`70 AÑOS` Leitmotif**               | Established `70 AÑOS` as an intentional visual leitmotif in: (1) Closed Envelope (`Alba Rosa` → `70 AÑOS`), (2) Letter (`70 AÑOS` → `ALBA ROSA QUIÑÓNEZ LÓPEZ`), (3) Hero (`70 AÑOS` eyebrow above headline), and (4) Location section intro eyebrow (`70 AÑOS · 12 DE SEPTIEMBRE DE 2026`). Perceived clearly without repetitive body copy.                                                                                                                                                                                        |
...
| **Hero `70 AÑOS` Treatment**          | Eyebrow `70 AÑOS` refined with uppercase `font-size: clamp(1rem, 2.8vw, 1.25rem)`, semibold weight (`700`), tracking (`0.24em`), richer gold color (`--alba-gold`), and text shadow (`0 2px 12px rgba(0,0,0,0.55)`). Spacing above headline set to `0.85rem`. `Alba Rosa Quiñónez López` remains dominant headline.                                                                                                                                                                                                                 |

...
- **Preview-only operational:** `PREVIEW_DB_URL`, `PREVIEW_SUPABASE_URL`, `PREVIEW_SUPABASE_SERVICE_ROLE_KEY`, `PREVIEW_MFA_BYPASS`, `PREVIEW_ADMIN_EMAILS` — used by Preview DB workflows and MFA bypass. Never used in Production.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/celebra-memories-sign/wrangler.json workers/celebra-memories-sign/worker-configuration.d.ts` (hash: c2509f24ef412298fb70fccd1c65b860)

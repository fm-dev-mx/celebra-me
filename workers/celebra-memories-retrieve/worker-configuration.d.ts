/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/celebra-memories-retrieve/wrangler.json workers/celebra-memories-retrieve/worker-configuration.d.ts` (hash: d1bfb5977d049322783a8839b044004d)
